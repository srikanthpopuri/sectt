 ...
 <header id="header" class="header">
    ...
    <div class="header-nav">
 	...
 	<div class="col-md-2 text-center">
			...
			<img src="images/banner/kcr.jpg" alt="" height="150" width="400">
<h5 style="width:259px;text-alig:left">Sri K Chandrashekar Rao Garu,
Hon'ble Chief Minister Telangana State</h5>
 		...
 		<div class="col-md-2 text-center">
            <a class="menuzord-brand pull-left flip mt-5 mb-5 mt-sm-10 mb-sm-20 col-md-12" href="index.php">
			<img src="images/banner/minister.jpg" alt="" height="150" width="400" style="margin-left:15px">
   <h5 style="width:"236px">Shri Koppula Eshwar Garu 
...
Telangana state</h5>
          ...
          <nav id="menuzord-right" class=" default theme-colored mb-15 text-center" style="clear:both;">
		...
		<div class="header-nav-wrapper navbar-scrolltofixed" style="background:#252525">
		<div class="container">
