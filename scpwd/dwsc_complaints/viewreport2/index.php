...
<b style="color:#C36;">Create Employee</b>
                    ...
                    <div class="panel-body" style="display: none">
                        ...
                        <div id="adminForm" style="display:none">
                            ...
                            <script type="text/javascript">
                                ...
                                setStateGet('adminForm','<?php echo SECURE_PATH;?>viewreport2/process.php','addForm=1');
                ...
                <section class="panel">
                    ...
                    <header class="panel-heading">
                        ...
                        <b style="color:#C36;">APPLICATION FOR SANCTION OF MARRIAGE INCENTIVE AWARD FOR</b><br />
                        <b style="color:#C36;">MARRIAGE BETWEEN DISABLED & NORMAL PERSON</b>
                    </header>
                    ...
                    <div class="panel-body">
                        ...
                        <section id="unseen">
                            <div id="adminTable">
                                ...
                                <script type="text/javascript">
                                    setStateGet('adminTable','<?php echo SECURE_PATH;?>viewreport2/process.php','tableDisplay=1&page=<?php if(isset($_GET['page'])){echo $_GET['page'];}else{ echo '1';}?>');
                                </script>
