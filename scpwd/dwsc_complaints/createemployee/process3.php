...
echo "select * from `createemployees` where username='".$username11."'";
...
setState('submitdata','<?php echo SECURE_PATH;?>createemployee/process.php','updateemployee_activate=1&username11=<?php echo $rec['username'];?>&assign_to='+$('#assign_to').val()+'');
