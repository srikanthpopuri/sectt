...
<b style="color:#C36;">Create Employee</b>
                    ...
                    <div class="panel-body" style="display: none">
                        ...
                        <div id="adminForm" style="display:none">
                            ...
                            <script type="text/javascript">
                                ...
                                setStateGet('adminForm','<?php echo SECURE_PATH;?>viewreport3/process.php','addForm=1');
                ...
                <section class="panel">
                    ...
                    <header class="panel-heading">
                        ...
                        <b style="color:#C36;">SANCTION OF SUBSIDY UNDER SPECIAL ECONOMIC SCHEME SUPPORT SCHEME</b><br />
                    ...
                    <div class="panel-body">
                        ...
                        <section id="unseen">
                            <div id="adminTable">
                                ...
                                <script type="text/javascript">
                                    setStateGet('adminTable','<?php echo SECURE_PATH;?>viewreport3/process.php','tableDisplay=1&page=<?php if(isset($_GET['page'])){echo $_GET['page'];}else{ echo '1';}?>');
                                </script>
