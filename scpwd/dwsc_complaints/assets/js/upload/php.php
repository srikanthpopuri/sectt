...
class qqFileUploader {
	...
	//		$session->image_resize($uploadDirectory . $filename . '.' . $ext,$uploadDirectory . $filename . '.' . $ext,250,250,0);
			...
			return array('success'=>true,'filename'=>$filename.'.'.$ext,'fakename'=>$pathinfo['filename'].'.' . $ext,'resize'=>'resized to '.round(($resize/1024)).'Kb','filetitle'=>$title,'filevalue'=>$pathinfo['filename']);
...
//$result = $uploader->handleUpload('../../../vehicle/phpajax/excelUploads/');
