...
<b style="color:#C36;">Create Employee</b>
                    ...
                    <div class="panel-body" style="display: none">
                        ...
                        <div id="adminForm" style="display:none">
                            ...
                            <script type="text/javascript">
                                ...
                                setStateGet('adminForm','<?php echo SECURE_PATH;?>viewreport4/process.php','addForm=1');
                ...
                <section class="panel">
                    ...
                    <header class="panel-heading">
                        ...
                        <b style="color:#C36;">APPLICATION UNDER RULE 4(1) OF THE TELANGANA STATE</b><br />
                        <b style="color:#C36;">MAINTENANCE OF PARENTS AND SENIOR CITIZENS RULES, 2011.</b>
                    </header>
                    ...
                    <div class="panel-body">
                        ...
                        <section id="unseen">
                            <div id="adminTable">
                                ...
                                <script type="text/javascript">
                                    setStateGet('adminTable','<?php echo SECURE_PATH;?>viewreport4/process.php','tableDisplay=1&page=<?php if(isset($_GET['page'])){echo $_GET['page'];}else{ echo '1';}?>');
                                </script>
