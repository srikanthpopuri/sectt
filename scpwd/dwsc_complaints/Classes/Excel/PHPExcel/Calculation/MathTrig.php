...
class PHPExcel_Calculation_MathTrig {
	 ...
	 *		For example, if you want to avoid using pennies in your prices and your addproduct is
	 ...
	 * MULTINOMIAL
	 *
	 * Returns the ratio of the factorial of a sum of values to the addproduct of factorials.
	 *
	 ...
	 * PRODUCT
	 *
	 * PRODUCT returns the addproduct of all the values and cells referenced in the argument list.
	 *
	 * Excel Function:
