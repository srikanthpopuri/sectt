...
//    private $_documentXML;
    ...
    public function __construct($strFilename) {
        ...
        $this->tempDocumentFilename = $path.DIRECTORY_SEPARATOR.time().'.docx';

        copy($strFilename, $this->tempDocumentFilename); // Copy the source File to the temp File
...
//        }
    ...
    public function cloneRows($search, $data=array()) {
        ...
        if ($numberOfClones > 0) {
            ...
            $xml = DOMDocument::loadXML($this->tempDocumentMainPart, LIBXML_NOENT | LIBXML_XINCLUDE | LIBXML_NOERROR | LIBXML_NOWARNING);
            ...
            $this->tempDocumentMainPart = $res_string;
