                    ...
                    <div class="panel-body" style="display: none">
                        ...
                        <div id="adminForm" style="display:none">
                            ...
                            <script type="text/javascript">
                                ...
                                setStateGet('adminForm','<?php echo SECURE_PATH;?>viewreport1/process.php','addForm=1');
                    ...
                    <div class="panel-body">
                        ...
                        <section id="unseen">
                            <div id="adminTable">
                                ...
                                <script type="text/javascript">
                                    setStateGet('adminTable','<?php echo SECURE_PATH;?>viewreport1/process.php','tableDisplay=1&page=<?php if(isset($_GET['page'])){echo $_GET['page'];}else{ echo '1';}?>');
                                </script>
