...
<script type="text/javascript">
    ...
    <script>
        function search_report() {
            ...
            setStateGet('adminTable','<?php echo SECURE_PATH;?>viewreport1/process.php','tableDisplay=1&search=true&from_date='+from_date+'&to_date='+to_date+'&district_sel='+district_sel);
        }
    </script>
...
if(isset($_GET['tableDisplay'])){
 ...
 $ap1 = $database->query("select count(id) as cnt from complaints_form WHERE status=1 $con");
    $w1_1 = mysqli_fetch_array($ap1);
    $ap = $database->query("select count(id) as cnt from complaints_form WHERE status in (2,4,6,8) $con");
    $w2 = mysqli_fetch_array($ap);
	
	$ap_2 = $database->query("select count(id) as cnt from complaints_form WHERE status in (2,4) $con");
            ...
            <section class="panel bordered_panel">
                ...
                <div>
                    <table style="width:100%;height:132px">
                        ...
                        <tr>
                            <td style="background: #d90022;text-align: center;color: #fff;">New Applications <h5 style="margin-top:0;font-size: 19px;"><?php echo $w1_1['cnt'];?></h5></td>
                            <td style="background: #1076f1;color: #fff;text-align: center;">Other Department<h5 style="margin-top:0;font-size: 19px"><?php echo $w3['cnt'];?></h5></td>
...
<div class="row state-overview">
    ...
    <?php
                ...
                echo '<div style="float: right;padding-bottom: 20px"><a class="label label-warning" style="font-size:14px;" href="' . SECURE_PATH . 'viewreport1/export.php?from_date=' . $_REQUEST['from_date'] . '&to_date=' . $_REQUEST['to_date'] . '&district_sel=' . $_REQUEST['district_sel'].'" target="_blank"><i class="fa fa-exchange"></i>Export to Excel</a></div>';
                ...
                <table class="table table-bordered" style="table-layout:fixed;overflow:hidden">
                    ...
                    <tr style="background: #eaeaea">
                        ...
                        <th colspan=7 style="text-align:center">Application Status</th>

                    </tr>
                    <tr style="background: #eaeaea">
                        <th style="text-align:center;background-color:#40cded;color:#fff">New Application</th>
                    ...
                    <?php
                        ...
                        while($dis_data = mysqli_fetch_array($dis_sel)){
                            ...
                            <tr style="background: #00416a;color: #fff;">
                                ...
                                <td align="center"><?php echo $total1['cnt'];?></td>
                                ...
                                <td align="center"><?php echo $a5['cnt'];?></td>
                                <td align="center"><?php echo $a6['cnt'];?></td>
                                <td align="center"><?php echo $a7['cnt'];?></td>
