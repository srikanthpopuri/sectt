...
function changeits1s(){
	...
	{
setState('submitdata','<?php echo SECURE_PATH;?>grievances_view/process.php','c_r_other=1&ides=<?php echo $ret_query01['unid'];?>&reasons='+$('#reasons99').val()+'&close_reassign='+$('#close_reassign').val()+'');
