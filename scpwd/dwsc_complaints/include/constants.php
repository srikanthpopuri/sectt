...
define("DB_SERVER", "10.3.38.116");
define("DB_USER", "root");
define("DB_PASS", "dwd@123");
define("DB_NAME", "dwsc_complaints");

define("SMS_USER", "srkrec");
define("SMS_PASSWORD", "srkr33");
define("SMS_SID", "SRKREC");

/*define("DB_SERVER", "localhost");
define("DB_USER", "root");
define("DB_PASS", "");
define("DB_NAME", "commune");
*/
/**
...
define('SECURE_PATH','http://'.$_SERVER['HTTP_HOST'].'/dwsc_complaints/');
...
define("SMSUSER","9160001559");
define("SMSPASS", "promo@123");
define("SENDERID" ,"PHONIX");
