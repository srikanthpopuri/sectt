                    ...
                    <div class="panel-body" style="display: none">
                        ...
                        <div id="adminForm" style="display:none">
                            ...
                            <script type="text/javascript">
                                ...
                                setStateGet('adminForm','<?php echo SECURE_PATH;?>viewreport7/process.php','addForm=1');
...
{
?>
          <b style="color:#C36;">Welfare of Disabled  & Senior Citizens</b><br/>
<?php } else {
...
$ret_query_dist=mysqli_fetch_array($query_dist);
 ...
 ?>
          <b style="color:#C36;">Department for Women, Children, Disabled & Senior Citizens - <?php echo $ret_query_dist['district']."District"; ?></b><br/>
                    ...
                    <div class="panel-body">
                        ...
                        <section id="unseen">
                            <div id="adminTable">
                                ...
                                <script type="text/javascript">
                                    setStateGet('adminTable','<?php echo SECURE_PATH;?>viewreport7/process.php','tableDisplay=1&page=<?php if(isset($_GET['page'])){echo $_GET['page'];}else{ echo '1';}?>');
                                </script>
