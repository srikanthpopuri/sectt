...
<script type="text/javascript">
    ...
    <script>
        function search_report() {
            ...
            setStateGet('adminTable','<?php echo SECURE_PATH;?>viewreport/process.php','tableDisplay=1&search=true&from_date='+from_date+'&to_date='+to_date+'&district_sel='+district_sel);
        }
    </script>
            ...
            <section class="panel bordered_panel">
                ...
                <div>
                    <table style="width:100%;height:132px">
                        ...
                        <tr>
                                                  <td style="background: #1076f1;color: #fff;text-align: center;">New Applications<h5 style="margin-top:0;font-size: 19px"><?php echo $w1_1['cnt'];?></h5></td>
