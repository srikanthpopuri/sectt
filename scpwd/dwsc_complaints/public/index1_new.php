      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-8 col-lg-8 col-md-6 col-sm-12">
            <div class="row">
              <div class="col-lg-5 col-md-12 text-center hidden-md hidden-sm hidden-xs">
                <div>
                  <div style="float:left;margin:5px"><img class="ts-logo img-responsive" src="<?php echo SECURE_PATH; ?>images/kcr.jpg" style="width:180px; height:180px" alt="logo" ></div>				  
                </div>
              </div>
              ...
              <div class="col-lg-6 col-md-10">
			    <div>
					<div style="float:left"><img class="ts-logo img-responsive" src="<?php echo SECURE_PATH; ?>images/emblem.png"  style="width:120px; height:120px" alt="logo"></div>
					<div class="navbar-brand-text text-xl-center" style="float:left">
