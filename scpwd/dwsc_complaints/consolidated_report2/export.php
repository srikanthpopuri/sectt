...
$objPHPExcel->getActiveSheet()->getCellByColumnAndRow('2', '1')->setValue("Statement of the Institution,Disposal & Pendency of claim in the Appellate Tribunals");
...
$objPHPExcel->getActiveSheet()->getStyle('A3:G3')->applyFromArray($styleArray2);
...
$objPHPExcel->getActiveSheet()->getCellByColumnAndRow('4', '3')->setValue("Total claims disposed during month");
$objPHPExcel->getActiveSheet()->getCellByColumnAndRow('5', '3')->setValue("Pending at the end of the month");
$objPHPExcel->getActiveSheet()->getCellByColumnAndRow('6', '3')->setValue("Remarks");
...
for($i=1;$i<=12;$i++){
    ...
    $q2 = $database->query("select sub_date from psc_rules WHERE ".$condition." status=6");
    ...
    $objPHPExcel->getActiveSheet()->getCellByColumnAndRow('6', $rcounter)->setValue();
