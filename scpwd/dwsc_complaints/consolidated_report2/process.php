...
<script type="text/javascript">
    ...
    <script>
        function search_report() {
            ...
            setStateGet('adminTable','<?php echo SECURE_PATH;?>consolidated_report2/process.php','tableDisplay=1&search=true&district_sel='+district_sel);
        }
    </script>
...
?>
    ...
    <?php
                ...
                echo '<div style="float: right;padding-bottom: 20px"><a class="label label-warning" style="font-size:14px;" href="' . SECURE_PATH . 'consolidated_report2/export.php?&district_sel=' . $_REQUEST['district_sel'].'" target="_blank"><i class="fa fa-exchange"></i>Export to Excel</a></div>';
                ...
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th style="text-align:center;">Total claims disposed during month</th>
