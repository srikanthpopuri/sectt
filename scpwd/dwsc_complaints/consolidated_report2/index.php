            ...
            <div class="col-sm-12">
                    ...
                    <div class="panel-body" style="display: none">
                        ...
                        <div id="adminForm" style="display:none">
                            ...
                            <script type="text/javascript">
                                ...
                                setStateGet('adminForm','<?php echo SECURE_PATH;?>consolidated_report2/process.php','addForm=1');
                ...
                <section class="panel">
                    ...
                    <header class="panel-heading">
                        ...
                        <b style="color:#C36;">Statement of Institution,Disposal & Pendency of claims in the Maintenance Tribunals</b><br />
                    </header>
                    ...
                    <div class="panel-body">
                        ...
                        <section id="unseen">
                            <div id="adminTable">
                                ...
                                <script type="text/javascript">
                                    setStateGet('adminTable','<?php echo SECURE_PATH;?>consolidated_report2/process.php','tableDisplay=1&page=<?php if(isset($_GET['page'])){echo $_GET['page'];}else{ echo '1';}?>');
                                </script>
